...
function Button({
  ...
  const [bgColor, setBgColor] = React.useState("#dc2626")
  ...
  React.useEffect(() => {
    ...
    const handler = (e: Event) => {
      ...
      if (d.bgColor !== undefined) setBgColor(d.bgColor)
  ...
  return (
    <Comp
      ...
      style={variant === "secondary" ? { backgroundColor: bgColor, color: textColor } : undefined}
      {...props}
    />
  )
}
